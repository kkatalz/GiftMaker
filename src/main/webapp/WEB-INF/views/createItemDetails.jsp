      ...
      <body>
        <div class="overflow-hidden min-h-[100vh] pb-20">
          <%@include file="header.jsp" %>
            <form method="post" action="createItemDetails" enctype="multipart/form-data"
              class="flex justify-center items-start gap-8 mx-[6%] my-[1.5%]" onsubmit="return validateCategory()">
              ...
              <div class="flex flex-col gap-4 w-[25vw]">
                        ...
                        <li>
                          <div class="flex items-center p-2 rounded hover:bg-gray-100">
                            <input id="category-<%=category.getId()%>" type="radio" value="<%=category.getId()%>"
                              name="category" class="w-4 h-4 bg-gray-100 border-gray-300">
                            <label for="category-<%=category.getId()%>"
                              class="w-full ms-2 text-sm font-medium rounded dark:text-gray-300">
                              <%=category.getName()%>
                            </label>
                          </div>
                        </li>
                ...
                <div class="flex flex-col space-y-4">
                  ...
                  <div class="flex flex-col space-y-4">
                    <div class="flex items-center p-3 text-2xl font-bold rounded-lg border border-neutral-200 w-[60%]">
                      <label>
                        <input type="number" name="age" class="w-full placeholder:italic outline-none" placeholder="Age"
